    ...
    render(){
        ...
        return(
            <div className="flex gap-4 items-center rounded-2xl bg-gray-200">
                ...
                <div className="p-1 m-1">
                    <h2 className="p-1 flex">Name: {name} 
                        {/* <div className="bg-emerald-500 mx-2 rounded-2xl font-semibold"><UserContext.Consumer>{({loggedInUser})=> <h1>{loggedInUser}</h1>}</UserContext.Consumer></div> */}
                    </h2>
